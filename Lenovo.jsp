...
<nav class="navbar navbar-default navbar-fixed-top slide">
  <div class="container">
    ...
    <input list="mobile" type="search" id="mySearch" class="form-control" placeholder="e.g. Iphone" >
    <datalist id="mobile">
    <option value="Apple">
    ...
    <span class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#pricing"><h4>PRICING</h4></a></li>
...
<li id="LI_1">
  <article id="ARTICLE_2">
      ...
      <div id="DIV_17">
        <img src="https://assets.mspcdn.net/t_c-desktop-normal,f_auto,q_auto,d_c:noimage.jpg/c/11854-45-1.jpg" id="IMG_18" />
  ...
  <li id="LI_7">
    Android 6.0 Marshmallow
      ...
      <section id="SECTION_42">
        ...
        <ul id="UL_44">
          <li id="LI_45">
            <button id="BUTTON_46" onclick="location.href='http://www.amazon.in/gp/offer-listing/B01N7IZM1H/?sort=price&/ref=as_li_tf_tl?ie=UTF8&camp=3626&creative=24790&creativeASIN=9380349300&linkCode=as2&tag=mysm-21&ascsubtag=20170330397448&condition=new';">
              Amazon.in<b id="STRONG_47">‎₹14,589</b>
            </button>
          </li>
          <li id="LI_48">
            <button id="BUTTON_49" onclick="location.href='https://www.flipkart.com/lenovo-k6-note-gold-32-gb/p/itmes68ahqn5shm7?pid=MOBES68AHHX4YHQZ&affid=sulakshanm&affExtParam1=electronics&affExtParam2=20170330397463';">
              Flipkart<b id="STRONG_50">‎₹14,980</b>
            </button>
          </li>
          <li id="LI_51">
            <button id="BUTTON_52" onclick="location.href='http://www.shopclues.com/lenovo-k6-note-4-gb-ram-32-gb-gold.html?ty=0&id=5-73-46e18856-d93b-4258-808c-e917bd81a317&mcid=aff&tid=nh&utm_source=Mysmartprice&OfferId=15';">
              Shopclues<b id="STRONG_53" >₹14,699</b>
            </button>
          </li>
        </ul>
        ...
        <div id="DIV_57">
          <div id="DIV_58">
            <div id="DIV_59">
              ...
              <meta content="5579" id="META_61" />
              <meta content="3480" id="META_62" /> ‎ <strong id="STRONG_64">‎₹14,589</strong>
            </div>
            <img src="http://mobile-phones.ucoz.com/mobile_phone_best_deals.gif" class="best">
          </div>
          <button id="BUTTON_65" onclick="location.href='http://www.amazon.in/gp/offer-listing/B01N7IZM1H/?sort=price&/ref=as_li_tf_tl?ie=UTF8&camp=3626&creative=24790&creativeASIN=9380349300&linkCode=as2&tag=mysm-21&ascsubtag=20170330397448&condition=new';">
            View Deal
          </button>
        </div>
      </section>
...
<li id="LI_1">
  <article id="ARTICLE_2">
      ...
      <div id="DIV_17">
        <img src="https://rukminim1.flixcart.com/image/832/832/mobile/b/q/p/lenovo-phab-2-plus-pb2-670m-original-imaeqcpw4shswuzd.jpeg?q=70" id="IMG_18" />
  ...
  <li id="LI_7">
    Android 6.0.1 Marshmallow 
      ...
      <section id="SECTION_42">
        ...
        <ul id="UL_44">
          <li id="LI_45">
            <button id="BUTTON_46" onclick="location.href='http://www.amazon.in/Lenovo-Phab-Plus-Smartphone-earphones/dp/B01FM7IT3K?/ref=as_li_tf_tl?ie=UTF8&camp=3626&creative=24790&creativeASIN=9380349300&linkCode=as2&tag=mysm-21&ascsubtag=20170330402165&condition=new';">
              Amazon.in<b id="STRONG_47">‎₹14,999</b>
            </button>
          </li>
          <li id="LI_48">
            <button id="BUTTON_49" onclick="location.href='https://www.flipkart.com/lenovo-phab-2-plus-gunmetal-grey-32-gb/p/itmeqcpncnvyfzdk?pid=MOBEQCPNG8KGCBQP&affid=sulakshanm&affExtParam1=electronics&affExtParam2=20170330402156';">
              Flipkart<b id="STRONG_50">‎₹13,999</b>
            </button>
          </li>
          <li id="LI_51">
            <button id="BUTTON_52" ><strike>
        ...
        <div id="DIV_57">
          <div id="DIV_58">
            <div id="DIV_59">
              <em id="EM_60">Flipkart</em>
              <meta content="5579" id="META_61" />
              <meta content="3480" id="META_62" /> ‎ <strong id="STRONG_64">‎₹13,999</strong>
            </div>
            <img src="http://mobile-phones.ucoz.com/mobile_phone_best_deals.gif" class="best">
          </div>
          <button id="BUTTON_65" onclick="location.href='https://www.flipkart.com/lenovo-phab-2-plus-gunmetal-grey-32-gb/p/itmeqcpncnvyfzdk?pid=MOBEQCPNG8KGCBQP&affid=sulakshanm&affExtParam1=electronics&affExtParam2=20170330402156';">
            View Deal
          </button>
        </div>
      </section>
...
<li id="LI_1">
  <article id="ARTICLE_2">
      ...
      <div id="DIV_17">
        <img src="https://assets.mspcdn.net/t_c-desktop-normal,f_auto,q_auto,d_c:noimage.jpg/c/11380-98-1.jpg" id="IMG_18" />
  ...
  <li id="LI_4">
    13MP Dual Rear Cameras | 8MP Front
  </li>
  <li id="LI_5">
    3500 mAh Battery
  </li>
  <li id="LI_7">
    2.15 GHz quad-core Snapdragon 820
      ...
      <section id="SECTION_42">
        ...
        <ul id="UL_44">
          <li id="LI_45">
            <button id="BUTTON_46" onclick="location.href='http://www.amazon.in/gp/product/B01FM7HV7K/ref=s9_acss_bw_cg_LenovoZ2_1a1?/ref=as_li_tf_tl?ie=UTF8&camp=3626&creative=24790&creativeASIN=9380349300&linkCode=as2&tag=mysm-21&ascsubtag=20170407952797&condition=new';">
              Amazon.in<b id="STRONG_47" >₹14,999</b>
            </button>
          </li>
          <li id="LI_48">
            <button id="BUTTON_49" ><strike>
              Flipkart<b id="STRONG_50">‎N/A</b></strike>
            </button>
          </li>
          <li id="LI_51">
            <button id="BUTTON_52" onclick="location.href='http://www.ebay.in/itm/Lenovo-ZUK-Z2-Plus-5-0-4G-VoLTE-13MP-4k-Camera-/152494089411?aff_source=mysmartprice';">
              Ebay<b id="STRONG_53">‎₹16,990</b>
            </button>
          </li>
        </ul>
        ...
        <div id="DIV_57">
          <div id="DIV_58">
            <div id="DIV_59">
              <em id="EM_60">Amazon</em>
              <meta content="5579" id="META_61" />
              <meta content="3480" id="META_62" /> ‎ <strong id="STRONG_64">‎₹14,999</strong>
            </div>
            <img src="http://mobile-phones.ucoz.com/mobile_phone_best_deals.gif" class="best">
          </div>
          <button id="BUTTON_65" onclick="location.href='http://www.amazon.in/gp/product/B01FM7HV7K/ref=s9_acss_bw_cg_LenovoZ2_1a1?/ref=as_li_tf_tl?ie=UTF8&camp=3626&creative=24790&creativeASIN=9380349300&linkCode=as2&tag=mysm-21&ascsubtag=20170407952797&condition=new';">
            View Deal
          </button>
        </div>
      </section>
